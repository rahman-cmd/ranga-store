...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p>Ratings: ${product.rating.rate}&nbsp &nbsp Reviews:  ${product.rating.count}</p>
...
const setInnerText = (id, value) => {
  document.getElementById(id).innerText = parseFloat(value).toFixed(2); // Math.round(value);
};
